...
impl<M: Model> Program<M> {
    ...
    fn render<W: Write>(&self, writer: &mut W, last_view: &mut String) -> Result<()> {
        ...
        // Flicker-free rendering: overwrite content in-place instead of
        // Clear(ClearType::All) which blanks the screen between frames.
        //
        // Insert EL (Erase in Line, \x1b[K) before each \r\n to clear
        // leftover characters when a line is shorter than the previous frame.
        // Then clear any remaining lines below with FromCursorDown.
        // Buffer everything with queue! and flush once at the end.
        let frame = view.replace("\r\n", "\x1b[K\r\n");
